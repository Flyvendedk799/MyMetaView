...
STAGE_MODELS: Dict[str, ModelSpec] = {
    ...
    "design_dna": _VISION_UTILITY,
    "visual_focus": _VISION_UTILITY,
    "ui_elements": _VISION_UTILITY,
    "classification": _TEXT_UTILITY,
    "tags": _TEXT_UTILITY,
    "brand_name": _TEXT_UTILITY,
    "brand_voice": _TEXT_UTILITY,
...
PURPOSE_STAGES: Dict[str, Stage] = {
    ...
    "design_dna": Stage.EXTRACTION,
    "visual_focus": Stage.COMPOSITION,
    "ui_elements": Stage.EXTRACTION,
    "brand_voice": Stage.REASONING,
